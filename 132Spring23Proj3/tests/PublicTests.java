...
public class PublicTests {
	...
	// My Tests
	// To test, print resultBuffer.toString() and compare it to the expected output
	@Test
	public void testCollapse() {
		GameModel model = new ClearCellGameModel(3, 3, new Random(1L));
		for (int i = 0; i < 3; i++) {
			model.setBoardCell(0, i, BoardCell.RED);
			model.setBoardCell(1, i, BoardCell.BLUE);
		}
